# linear_q_bus_priority_multiple_seeds.py
# semi-gradient Q-learning with tile coding + bus priority wrapper.
# same setup as linear_q_multiple_seeds.py but with buses injected
...
if __name__ == "__main__":
    ...
    for beta in betas:
        ...
        print(f"\n{'='*50}")
        print(f"Linear Q-Learning — beta={beta} ({beta_label})")
        print(f"{'='*50}")
        ...
        for seed in seeds:
            ...
            env = SumoEnvironment(
                ...
                out_csv_name=f"outputs/linear-q-2way-single-intersection/linear_q_bus_{beta_label}_seed_{seed}",
                single_agent=True,
                use_gui=False,
                num_seconds=100000,
            )
    ...
    print("\n===== ALL LINEAR Q-LEARNING BUS PRIORITY RUNS COMPLETE =====")
